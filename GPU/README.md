...
```sh
cmake .. -DCMAKE_PREFIX_PATH=/home/jetson-micro/Desktop/..../nvcomp-linux-sbsa-4.1.1.1_cuda12-archive/          -DCMAKE_BUILD_TYPE=Release          -DBUILD_GDS_EXAMPLE=ON -DCMAKE_CUDA_COMPILER=/usr/local/cuda-12.6/bin/nvcc -DCMAKE_CUDA_ARCHITECTURES=80 
